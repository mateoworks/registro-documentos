...
class EstudiantePolicy
{
    ...
    {
        return $user->hasPermissionTo('ver estudiantes');
    }
    ...
    {
        return $user->hasPermissionTo('crear estudiantes');
    }
    ...
    {
        return $user->hasPermissionTo('editar estudiantes');
    }
    ...
    {
        return $user->hasPermissionTo('eliminar estudiantes');
    }
    ...
    {
        return $user->hasPermissionTo('restaurar estudiantes');
    }
    ...
    {
        return $user->hasPermissionTo('forzar eliminacion estudiantes');
    }
}
