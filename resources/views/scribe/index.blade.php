...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "http://registro-documentos.test";
        var useCsrf = Boolean();
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-current-user">Handle the incoming request.</a>
                            </li>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: August 27, 2023</li>
    </ul>
</div>
...
<aside>
    <strong>Base URL</strong>: <code>http://registro-documentos.test</code>
</aside>
...
<div class="bash-example">
    ...
    --get "http://registro-documentos.test/api/user" \
...
<div class="javascript-example">
    ...
    "http://registro-documentos.test/api/user"
);
...
<div class="bash-example">
    ...
    "http://registro-documentos.test/api/login" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"email\": \"guido69@example.net\",
    \"password\": \"facere\",
    \"device_name\": \"voluptates\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="guido69@example.net"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>guido69@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>voluptates</code></p>
                    ...
                    <h2 id="endpoints-GETapi-current-user">Handle the incoming request.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://registro-documentos.test/api/current-user" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://registro-documentos.test/api/current-user"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://registro-documentos.test/api/users" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://registro-documentos.test/api/users"
);
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="lhirthe@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>lhirthe@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://registro-documentos.test/api/users/dolor" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://registro-documentos.test/api/users/dolor"
);
...
<div class="bash-example">
    ...
    "http://registro-documentos.test/api/users/0471a446-235e-44b6-86a4-c74eab175a1c" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"quasi\",
    \"email\": \"mosciski.ashley@example.net\",
    \"password\": \"illo\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="0471a446-235e-44b6-86a4-c74eab175a1c"
               data-component="url">
    <br>
<p>The ID of the user. Example: <code>0471a446-235e-44b6-86a4-c74eab175a1c</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="mosciski.ashley@example.net"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>mosciski.ashley@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://registro-documentos.test/api/logout" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
